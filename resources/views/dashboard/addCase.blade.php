        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/insertCase" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            @if ($errors)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               ...
                               <input id="Industry" type="text"  class="form-control" name="Industry"  autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="ResultsEamil" type="email"  class="form-control" name="ResultsEamil"  autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="KeywordsLink"  type="text" class="form-control" name="KeywordsLink"  autofocus>
